...
class AACommandsFrameListener : public Ogre::FrameListener, public Ogre::WindowEventListener, public OIS::KeyListener, public OIS::MouseListener
{
public:    
    ~AACommandsFrameListener(void);

    static AACommandsFrameListener *GetInstance();    
