...
EntityMaterialInstance::EntityMaterialInstance (Ogre::Entity *e) {
...
void EntityMaterialInstance::setMaterialName (Ogre::String name) {
    std::vector<SubEntityMaterialInstance *>::iterator it, iend;
    iend = mSEMIs.end ();
    for (it = mSEMIs.begin (); it != iend; ++it) {
...
void EntityMaterialInstance::setSceneBlending (Ogre::SceneBlendType sbt) {
    std::vector<SubEntityMaterialInstance *>::iterator it, iend;
    iend = mSEMIs.end ();
    for (it = mSEMIs.begin (); it != iend; ++it) {
...
void EntityMaterialInstance::setTransparency (Ogre::Real transparency) {
