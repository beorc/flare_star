...
std::map<String, uint8> *nameToNumber1= new std::map<String, uint8>;
...
void OgreMaxScene::LoadEntity(const TiXmlElement* objectElement, const MovableObjectOwner& owner)
{
    ...
    size_t subentityCount = (size_t)std::min((size_t)parameters.subentities.size(), (size_t)entity->getNumSubEntities());
